...
energy_demand = hp.timeseries.thermal_energy_output.sum()/4
print(energy_demand)

user_profile.thermal_energy_demand.to_csv("thermal_energy_demand.csv")
hp.timeseries.to_csv("hp_timeseries.csv")